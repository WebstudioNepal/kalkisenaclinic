...
function TextContent({
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col justify-center">
      <h2 className="font-heading text-[36px] leading-none text-black">{title}</h2>
...
export default function AboutSplitSection({
  ...
  return (
    <section id={id} className="scroll-mt-8 bg-white py-8 lg:py-14">
      <PageContainer>
        <div
          className={cn(
            "flex flex-col gap-12 lg:items-center lg:gap-[72px]",
